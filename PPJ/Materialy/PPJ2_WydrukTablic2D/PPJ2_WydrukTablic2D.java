/* 
 * Program pozwala drukować generowane tablice dwuwymiarowe
 * o dowolnym kształcie z wyrównaniem kolumn i opisem indeksów
 * w wierszach i kolumnach. 
 * Przykład - tablica 4 wiersze o rozmiarach 3, 5, 6, 4:
 * 
       0    1    2   3    4    5 
    ----------------------------
 0:  672  272 -511 
 1:  921 -593   34 110  -44 
 2:  712  548  626 -15 -676 -483 
 3: -599  219 -805 265 
...
public class PPJ2_WydrukTablic2D {  
  ...
  public static void main(String[] args) {  
    ...
    while(true) { // Konwersacja
      ...
      System.out.println("Wydruk bez wyrównania kolumn");
      for(int i=0; i<m; ++i) {
        for(int j=0; j<T[i].length; ++j)
...
/* Ćwiczenie
Zmodyfikować program tak, aby oprócz generacji losowej
można było wprowadzić elementy tablicy z klawiatury.
Przyjąć konwencję: jeżeli zakres generacji z==0, to dane
podaje z klawiatury użytkownik.
*/