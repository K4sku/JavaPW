...
public class PPJ4_StosyTestowanie {
  public static void main(String[] args) throws Exception {  
    ...
    s1.push(11);
    s1.push(22);              // Opakowanie do Integer
    s1.push("wstawka");
    ...
    System.out.println("\nPrzenoszenie: Stack<Integer> ==> Stack<Number>");
...
*/
  ...
  // Stos "dostawca" może dostarczać obiekty T lub podtypy T,
...
class Stack<E> {
  ...
  public Stack(int size) {
    //stack = new E[size];  // Error: nie mo�na utworzy� E[]
