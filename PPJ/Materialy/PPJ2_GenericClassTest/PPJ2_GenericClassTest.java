...
public class PPJ2_GenericClassTest {
  ...
  public static void main(String[] args) {  
    ...
    reverse(a); reverse(b);
    //System.out.println(a);	// [Ljava.lang.Integer;@4517d9a3
    //System.out.println(b);	// [Ljava.lang.String;@372f7a8d
    ...
    // Para<String, String>[] tpss = new Para<String, String>[10];
    // Error: Cannot create a generic array of Para<String,String>
    @SuppressWarnings ("unchecked") 
    Para<String, String>[] tpss = (Para<String, String>[]) new Para<?, ?>[10];
    //Para<String, String>[] tpss = (Para<String, String>[]) new Object[10];
    ...
    System.out.println(new Para<Integer, Integer>());
  }
