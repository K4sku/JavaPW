/* Rozkład liczby wymiernej na czść całkowitą i ułamki babilońskie postaci 1/m. 
    Kolejny ułamek babiloński w rozkładzie powinien być największy z możliwych.
    Program działa poprawnie, jeśeli nie następuje przekroczenie 
    zakresu reprezentacji liczb long. 
   ...
   Ćwiczenie: wykryć i zasygnalizować taką sytuację. 
   W czasie działania programu następna liczba babilońska 
   jest większa od poprzedniej albo ujemna.
*/

import java.util.Scanner;

public class PPJ2_UłamkiBabilońskie {  
